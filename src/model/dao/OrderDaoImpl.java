...
public class OrderDaoImpl implements OrderDao{
    ...
    public int addNewOrder(Order order) {
        ...
        try(
            ...
            String message = rowAffect>0 ? "Insert order successfully" : "Insert order Failed";
    ...
    public int deletedOrderById(Integer id) {
        ...
        try(
            ...
            if(order != null){
                ...
                int rowAffect = preparedStatement.executeUpdate();
                String message = rowAffect>0? "Deleted successfully" : "Deleted failed";
                System.out.println(message);
    ...
    public List<Order> queryAllOrders() {
        ...
        try(
            ...
            List<Order> orderList = new ArrayList<>(); //store data as array we use list
            while (resultSet.next()){
                orderList.add(
                        Order.builder()
                                .id(resultSet.getInt("id"))
